...
class Config {
  ...
  /// Generated by SiteNative 30-11-2022 12:53:31
  /// App UID: 96a96ead-61f8-56c8-10fd-2b1a4d6483eb
  /// Version: https://app.startapp.pro/backend/
  /// API server: {VERSION}

  /// *** App config *** ///
  // App name
  static String appName = "Аренда подъемников";
  // App link
  static String appLink = "https://forwardup.ru";
  ...
  // User agent
  static String userAgent = "В нашем приложении вы сможете заказать подъемник в аренду, так же смотреть характеристики подъемников, скачивать руководства по эксплуатации, делать заявки на ремонт.";
  // Admin email
  static String appEmail = "defender198931@gmail.com";
  // Template
  ...
  // Signing
  static String osSigning = "ed7f7dcd6e8c2a0269ebfe9c4244d11f35d2c4812483261b6ff2763467e4bb41";
  // Enabled android?
