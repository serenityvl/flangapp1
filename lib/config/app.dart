...
class Config {
  ...
  /// Generated by SiteNative 28-09-2022 09:47:03
  ...
  // Signing
  static String osSigning = "5d8f045691fc09ccf87ea08de8eca78d65198b6b9be86bc2d3e2740e9269b9ee";
  // Enabled android?
  static bool osAndroidEnabled = true;

  /// *** Website styles *** ///
  // List div for hide in app
  static List<String> cssHideBlock = [".xoo-wsc-basket",".xoo-wsc-container",".bshipp",".xoo-wsc-container",".navbar-controls",".page-header",];
